...
export interface ApiPortfolioTagPortfolioTag
  extends Struct.CollectionTypeSchema {
  collectionName: 'portfolio_tags';
  info: {
    displayName: 'Portfolio Tag';
    pluralName: 'portfolio-tags';
    singularName: 'portfolio-tag';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::portfolio-tag.portfolio-tag': ApiPortfolioTagPortfolioTag;
